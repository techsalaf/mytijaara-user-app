      ...
      if (_formKeyStep2!.currentState!.validate()) {
        if (identityNumber.isEmpty) {
          ...
          deliverymanRegiController.registerDeliveryMan(DeliveryManBody(
            ...
            referCode: _referTextController.text, type: "is_delivery",
    ...
    if(ResponsiveHelper.isDesktop(context)) {
      ...
      if(fName.isEmpty) {
        ...
        deliverymanRegiController.registerDeliveryMan(DeliveryManBody(
          ...
          earning: deliverymanRegiController.dmTypeIndex == 1 ? '1' : '0',
          zoneId: deliverymanRegiController.zoneList![deliverymanRegiController.selectedZoneIndex!].id.toString(),
          vehicleId: deliverymanRegiController.vehicles![deliverymanRegiController.vehicleIndex!].id.toString(), type: "is_delivery",
          referCode: _referTextController.text,
        ));
      }
    }
